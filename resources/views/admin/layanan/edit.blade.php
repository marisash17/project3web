...
<div class="container my-4">
    <div class="card-custom">
        ...
        <div class="text-center mb-4">
            <i class="bi bi-pencil-square fs-1 d-block text-custom-blue"></i>
            <h3 class="fw-bold text-custom-blue">Edit Layanan</h3>
        </div>
        ...
        <form action="{{ route('admin.layanan.update', $layanan->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="jenis_layanan" class="form-control form-control-custom" value="{{ $layanan->jenis_layanan }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                @if($layanan->gambar)
                    ...
                    <img src="{{ asset('storage/'.$layanan->gambar) }}" alt="Gambar Layanan" width="150" class="mt-1">
                @endif
            </div>
